package net.runelite.client.plugins.kitschinfernologger;
...
public class kitschInfernoLoggerPlugin extends Plugin{
    ...
    private void textfilecreator(String killcount, String duration) {
        log.info("textfile attempted to be created");
